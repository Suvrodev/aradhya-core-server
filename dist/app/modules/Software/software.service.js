...
//Update Software
const updateSoftwareFromDB = (productId, bookData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield software_model_1.SoftwareModel.findByIdAndUpdate({ _id: productId }, bookData, {
        new: true,
    });
    return result;
});
